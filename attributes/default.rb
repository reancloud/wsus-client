...
default['wsus-client']['wsus_server']                              = 'http://10.0.2.172:8530'

# Defines the current computer update group.
# => Truthy value also enable client-side update group targeting.
default['wsus-client']['update_group']                             = nil

# Disables access to Windows Update (or your WSUS server).
default['wsus-client']['disable_windows_update_access']            = false
# Allows signed non-Microsoft updates.
default['wsus-client']['enable_non_microsoft_updates']             = true
# Authorizes Users to approve or disapprove updates.
default['wsus-client']['allow_user_to_install_updates']            = false
# Defines whether minor update should be automatically installed.
default['wsus-client']['auto_install_minor_updates']               = false
# Disables automatic reboot with logged-on users.
default['wsus-client']['no_reboot_with_logged_users']              = true
...
default['wsus-client']['automatic_update_behavior']                = :disabled
...
default['wsus-client']['detection_frequency']                      = 22
...
default['wsus-client']['schedule_install_day']                     = :every_day
# Defines the time of day in 24-hour format to schedule update install. (0-23)
default['wsus-client']['schedule_install_time']                    = 0
...
default['wsus-client']['schedule_retry_wait']                      = 0
...
default['wsus-client']['reboot_warning']                           = 5
